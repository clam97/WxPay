...
public class PropertiesUtil {
    ...
    private static org.ToolUtil.ResourceLoader loader = org.ToolUtil.ResourceLoader.getInstance();
    private static ConcurrentMap<String, String> configMap = new ConcurrentHashMap<String, String>();
    private static final String DEFAULT_CONFIG_FILE = "weixin.properties";
